    ...
    <>
      <div className="footer bg-gray-200 py-8 mt-8">
        <div className="container  mx-auto">
          ...
          <form className="input flex items-center justify-between flex-wrap md:flex-nowrap gap-4 px-4">
            <input
              type="email"
            ...
            <button
              type="submit"
              className="capitalize w-full md:w-[15%] mx-auto  rounded text-white bg-green-700 hover:bg-green-800 duration-300 text-sm px-4 py-2">
              share app link
            </button>
          </form>
          ...
          <div className="flex my-4 items-center justify-between flex-wrap  border-gray-300 border-y py-6">
            <div className="flex items-center justify-center w-full xl:w-auto gap-2 flex-wrap">
              ...
              <img src={amazon} className="w-20" alt="amazonPay" />
              <img
                src={express}
                className="w-20"
                alt="americanExpress"
            ...
            <div className="flex items-center justify-center w-full xl:w-auto gap-2 flex-wrap">
              ...
              <img src={appStore} className="w-24" alt="apple" />
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full">
            ...
            <div
              className=" p-4 focus-within:ring sm:flex sm:items-center sm:gap-4">
              <input
                type="email"
                id="UserEmail"
                placeholder="Email..."
                className="w-full py-3 rounded px-2 border-none focus:border-transparent focus:ring-transparent sm:text-sm"
              />

              <button
                className="mt-1 w-full bg-green-700 rounded px-6 py-3 text-sm font-bold tracking-wide text-white transition-none hover:bg-green-800 sm:mt-0 sm:w-auto sm:shrink-0"
              >
                Share App Link
              </button>
            </div>
